...
build/kernel: prepare build/loader.o build/vga.o build/main.o
	ld -m elf_i386 -nostdlib --script=linker.ld -n -o build/kernel build/loader.o build/vga.o build/main.o
